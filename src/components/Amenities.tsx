...
import { Waves, Wifi, Car, Utensils, Wind, Tv, Dumbbell, Trees, Shield, Users, Bed, Bath } from "lucide-react";
const amenities = [{
  icon: Waves,
  title: "Outdoor Pool",
  ...
  return <section className="bg-background py-[60px]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16 max-w-3xl mx-auto">
          {specs.map((spec, index) => <Card key={index} className="shadow-card text-center">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {amenities.map((amenity, index) => <Card key={index} className="shadow-card hover:shadow-villa transition-shadow duration-300">
          ...
          <Card className="max-w-2xl mx-auto shadow-villa">
            <CardContent className="p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="#availability" className="inline-flex items-center justify-center px-6 py-3 bg-villa-ocean hover:bg-villa-ocean-light text-white rounded-md font-medium transition-colors shadow-villa">
                  Check Availability
                </a>
                <a href="#contact" className="inline-flex items-center justify-center px-6 py-3 border-2 border-villa-ocean text-villa-ocean hover:bg-villa-ocean hover:text-white rounded-md font-medium transition-colors">
                  Contact Us
                </a>
              </div>
            </CardContent>
