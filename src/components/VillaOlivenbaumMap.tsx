            ...
            <Card className="overflow-hidden shadow-villa">
              <CardContent className="p-0">
                <div className="aspect-video">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2647.6915765746453!2d16.302540475693068!3d43.533629260156914!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x13354317ffda0207%3A0x28a38342c5d8e007!2sVilla%20Olivenbaum%20%2F%20Olive%20Tree!5e1!3m2!1shr!2shr!4v1757543991794!5m2!1shr!2shr"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
                    ...
                    title="Villa Olivenbaum Location"
                  />
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="mt-8 border-villa-ocean/20 bg-villa-cream/50">
              <CardContent className="p-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground mb-1">Villa Address</h4>
                    <p className="text-muted-foreground">
                      Crvena zemlja 43, Kaštel Štafilić, Croatia
                    </p>
                  </div>
                </div>
              </CardContent>
...
export default VillaOlivenbaumMap;